...
"""
Adapted from https://github.com/jbranchaud/mybin/blob/master/jekyll-post :
...
def main():
    ...
    # if Dir is specified, append to front of filename, else use _posts by default (assumes this script is used at root level)
    if args.Dir:
